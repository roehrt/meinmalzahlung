    ...
    <div className="container">
      ...
      <div>
        <IconCard
          title="Step 1"
          iconSmall={
            <Image src={DownloadIcon} alt="Download" height={80} />
          }
          iconLarge={
            <Image src={DownloadIcon} alt="Download" height={130} />
          }
          description={(
            <>
              Install the
              {' '}
              <a href="https://www.ausweisapp.bund.de/download">AusweisApp2</a>
              {' '}
              on your smartphone or get a compatible
              {' '}
              <a href="https://www.ausweisapp.bund.de/usb-kartenleser">USB card reader</a>
              {' '}
              and scan the
              {' '}
        ...
        <IconCard
          ...
          iconLeft
          iconSmall={
            <Image src={SecureIcon} alt="eID-PIN" height={80} />
          }
          iconLarge={
            <Image src={SecureIcon} alt="eID-PIN" height={130} />
          }
          description={(
            <>
        ...
        <IconCard
          title="Step 3"
          iconSmall={
            <Image src={BankIcon} alt="Transaction" height={80} />
          }
          iconLarge={
            <Image src={BankIcon} alt="Transaction" height={130} />
          }
          description={(
            <>
