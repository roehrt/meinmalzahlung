...
const IBANInput = () => {
    ...
    const [ibantxt, setIBAN] = useState("");
    const [holdertxt, setHolder] = useState("");

    useEffect(() => {
        setValid(IBAN.isValid(ibantxt) && holdertxt!="");
    }, [ibantxt, holdertxt])
        ...
        <>
            <div className="container">
                ...
                <div className="step">
                    ...
                    <div className="step-description">
                        <input className="account-owner" onChange={(evt)=>{setHolder(evt.target.value)}} placeholder='Enter Name'/>
                    </div>
                </div>
